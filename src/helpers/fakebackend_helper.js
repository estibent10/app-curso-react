...
//dashboard > get recent users
export const getRecentUsers = () => get(url.GET_RECENT_USERS)

//dashboard > get Latest Transactions
export const getLatestTransaction = () => get(url.GET_LATEST_TRANSACTION)

//dashboard > get Latest Orders
export const getLatestOrders = () => get(url.GET_LATEST_ORDERS)
